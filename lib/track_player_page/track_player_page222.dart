...
class TrackPlayer222 extends StatefulWidget {
  const TrackPlayer222({
    Key? key,
    required this.track,
  }) : super(key: key);
  ...
  @override
  _TrackPlayer222State createState() => _TrackPlayer222State();
}

class _TrackPlayer222State extends State<TrackPlayer222> {
