...
class AudioPlayerFRG extends StatefulWidget {
  const AudioPlayerFRG({
    required this.audio,
  ...
  @override
  _AudioPlayerFRGState createState() => _AudioPlayerFRGState();
}

class _AudioPlayerFRGState extends State<AudioPlayerFRG> {
...
class _PositionSeekWidgetState extends State<PositionSeekWidget> {
  ...
  Widget build(BuildContext context) => SliderTheme(
        data: SliderTheme.of(context).copyWith(
          activeTrackColor: const Color(0xFFDEE1E6),
