...
class AppStateNotifier extends ChangeNotifier {
  AetheriusCloudFirebaseUser? initialUser;
  AetheriusCloudFirebaseUser? user;
  ...
  void update(AetheriusCloudFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
        ...
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: 'paidHomePage',
              path: 'paidHomePage',
              builder: (context, params) => PaidHomePageWidget(),
            ),
            FFRoute(
              name: 'createTrack',
              path: 'createTrack',
              asyncParams: {
                'albumRef': getDoc('album', AlbumRecord.serializer),
              },
            ...
            FFRoute(
              name: 'createAlbum',
              path: 'createAlbum',
              builder: (context, params) => CreateAlbumWidget(),
            ),
            FFRoute(
              name: 'startPage',
              path: 'startPage',
            ...
            FFRoute(
              ...
              builder: (context, params) => AlbumPageWidget(
